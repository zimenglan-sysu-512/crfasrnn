...
def _Net_forward(self, blobs=None, start=None, end=None, **kwargs):
    ...
    if kwargs:
        ...
        for in_, blob in kwargs.iteritems():
            ...
            n_batch   = blob_shape[0]
            n_channel = blob_shape[1]
            n_height  = blob_shape[2]
            n_width   = blob_shape[3]
            # print "layer name:", in_
            # print "n_batch:",   n_batch
            # print "n_channel:", n_channel
            # print "n_height:",  n_height
            # print "n_width:",   n_width
            self.blobs[in_].reshape(n_batch, n_channel, n_height, n_width)
            # print "reshape:", self.blobs[in_].data.shape
